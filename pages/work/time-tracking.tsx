    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-24 px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }} className="max-w-3xl mb-16"><p className="text-lg text-slate-600 leading-relaxed">Location tracking only activates during a work session — no session means no GPS access. Privacy by design. The system captures GPS waypoints, computes regular versus overtime hours per calendar day, and triggers async manager notifications when daily thresholds are exceeded. At month end, every team member's hours are already calculated, overtime split out, and billing amounts computed with configurable hourly and overtime rates. Export to payroll in one click.</p></motion.div>
