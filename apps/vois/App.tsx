...
import { Navbar, scrollToSection } from '@li/shared/components/Navbar';
import { setCurrentSection, setOnChatOpen, setOnChatMessageSent, setOnCardVerified, areAllCardsVerified, resetCardVerifications, setOnAppOpened, setVideoSyncActive, setVideoSyncTime } from '@li/shared/components/deviceState';
import { getVideoScenario } from './lib/videoSyncTimeline';
import type { SectionId } from '@li/shared/components/deviceState';
