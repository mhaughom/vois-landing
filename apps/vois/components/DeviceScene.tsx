...
import type { PhoneScreen } from '@li/shared/components/deviceState';
export type { SectionId, DemoState, DemoDevice, PhoneScreen } from '@li/shared/components/deviceState';
export {
  setCurrentSection,
  setOnChatOpen,
...
import {
  ...
  DEFAULT_HIGHLIGHT,
  getLabelCardColor,
} from '@li/shared/lib/categoryColors';
